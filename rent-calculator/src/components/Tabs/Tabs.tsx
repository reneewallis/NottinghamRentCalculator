...
export default function Tabs(){
    ...
    <div className="mt-2 w-full">
        ...
        <div hidden={tabs.wrappedTabArr.length !== 0} className="flex flex-col items-center mt-20 mx-auto w-fit h-fit p-10 bg-gray-800 border-solid border-gray-200 border-3 inset-shadow-sm ring-2 ring-gray-100/60 rounded-2xl">
