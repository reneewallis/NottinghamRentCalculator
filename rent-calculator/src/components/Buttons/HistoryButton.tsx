...
function HistoryButton({showHistory, onClick}: HistoryButtonProps){
    return(
        <button key={"historyButton"} className={"flex justify-center items-center h-9 w-9 my-1 text-gray-200 rounded-full transition-colors duration-200 focus:outline-none cursor-pointer hover:bg-fuchsia-700 hover:text-gray-50"} onClick={onClick}>
            {showHistory? 
