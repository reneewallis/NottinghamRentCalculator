            ...
            <ThemeProvider theme={dateTheme}>
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="en-gb">
                    <label className="flex flex-col font-normal focus-within:font-semibold focus-within:text-gray-50 transition-colors">
                        <span className={`text-gray-200 whitespace-nowrap ${alignmentMap[alignment]}  hover:text-gray-100 text-2xl mb-2 cursor-pointer`}>
                            {label}
                        </span>
                        <DatePicker onChange={(value, context) => {
                            if (controlled){
