...
export type CalculatorAction =
  ...
  | ShortfallActionChangeBenefitType
  | ShortfallActionCalculate
  | BalanceActionSetStartDate
  | BalanceActionStartDateError
  | BalanceActionChangeStartDate
  | BalanceActionCaluclateStartingBalance
  | ForecastActionChangePaymentFrequency
  | ForecastActionSetForecastDate
  | ForecastActionForecastDateError
  | ForecastActionChangeForecastDate
  | ForecastActionCalculateTotalInstallments
