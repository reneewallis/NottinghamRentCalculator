...
type MainPanelElement = ReactElement<TextBoxProps> | ReactElement<DateBoxProps> | ReactElement<InstallementScrollerProps>;
type SidePanelElement = ReactElement<TextBoxProps>| ReactElement<DropdownBoxProps>;
